...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
        ...
        KC_LCTL,  KC_LGUI, KC_LALT, RGB_TOG, ADJUST,  KC_SPC, KC_SPC, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_RCTL
    ),
    ...
    [_FN] = LAYOUT(
        ...
        _______, KC_HOME, KC_UP,   KC_END,  _______, KC_F11,  KC_F12,  KC_HOME, KC_UP,   KC_END,  KC_PSCR, KC_PGUP,
        _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_INS,  KC_PGDN,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, RGB_RMOD,_______, RGB_MOD, RGB_TOG, _______, _______, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU
    ),
    ...
    [_ADJUST] = LAYOUT(
        ...
        _______, RGB_SPD, _______, RGB_SPI, _______, _______, _______, KC_P1,   KC_P2,   KC_P3,   _______, GAME,
        _______, RGB_RMOD,_______, RGB_MOD, RGB_TOG, _______, _______, KC_P0,   KC_PDOT, KC_NLCK, QWERTY,  COLEMAK
    ),
};
