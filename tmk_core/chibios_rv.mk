...
CHIBIOS_RV = $(TOP_DIR)/../ChibiOS-RISC-V
# Startup files. Try a few different locations, for compability with old versions and
# for things hardware in the contrib repository
STARTUP_MK = $(CHIBIOS_RV)/os/common/startup/RISCV-CLIC/compilers/GCC/mk/startup_$(MCU_STARTUP).mk
include $(STARTUP_MK)
...
PLATFORM_MK = $(CHIBIOS_RV)/os/hal/ports/$(MCU_FAMILY)/$(MCU_SERIES)/$(PLATFORM_NAME).mk
include $(PLATFORM_MK)
...
PORT_V = $(CHIBIOS_RV)/os/common/ports/RISCV-CLIC/compilers/GCC/mk/port.mk
include $(PORT_V)
# Other files (optional).
include $(CHIBIOS)/os/hal/lib/streams/streams.mk

RULESPATH = $(CHIBIOS_RV)/os/common/startup/RISCV-CLIC/compilers/GCC
...
ASFLAGS += -fomit-frame-pointer -mstrict-align

CXXFLAGS += $(COMPILEFLAGS)
CXXFLAGS += -fno-rtti

LDFLAGS +=-Wl,--gc-sections -fomit-frame-pointer -nostartfiles -mstrict-align
